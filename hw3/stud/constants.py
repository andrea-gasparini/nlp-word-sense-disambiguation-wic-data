...
PREPROCESSED_GLOSSBERT_TRAIN_PATH: str = "../../data/preprocessed/SemCor10+wic_train.json"
PREPROCESSED_GLOSSBERT_VALID_PATH: str = "../../data/preprocessed/semeval2007.json"
PREPROCESSED_GLOSSBERT_TEST_PATH: str = "../../data/preprocessed/wic_dev.json"
